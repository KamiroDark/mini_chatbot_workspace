...
app.post('/api/build', (req, res) => {
    ...
    // Normalizar ids a números (por si vienen como strings) y usar la variable correcta
    ...
    archive.on('error', (err) => {
        ...
        if (!res.headersSent) {
            ...
            // cerrar la respuesta si ya empezó a enviarse
            res.destroy(err);
        }
    });
...
// Función para generar script shell (Linux/Mac)
...
// Función para generar script batch (Windows)
